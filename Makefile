...
#AVR_DUDE = /usr/bin/avrdude -C /etc/avrdude/avrdude.conf
...
FLAGS_GCC = -c -g -Os -Wall -fno-exceptions -ffunction-sections -fdata-sections -mmcu=${ARDUINO_MODEL} -DF_CPU=16000000L -MMD -DUSB_VID=null -DUSB_PID=null -DARDUINO=${ARDUINO_VERSION}
FLAGS_GPP = ${FLAGS_GCC}
